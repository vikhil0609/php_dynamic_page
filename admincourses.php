...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if ($conn->query($sql) === TRUE) {
            $showMess = "Course Added Successfully";
      } else {
            // $showError = "COURSE  NOT ADDED";
            echo "Cannot Add Course";
      }
...
if ($showMess) {
      ...
      echo '<div class="alert alert-success h-100" role="alert">
                  <p class="fw-bold mb-0 ">' . $showMess . '<p> 
                </div> ';
}
?>
<?php
            ...
            <div class="m-auto w-75">
                  <form method="POST" action="admincourses.php">
                        ...
                        <div class="mb-3">
                              ...
                              <input type="text" style="height: 7.5rem;" class="form-control" name="courseDesc"
                                    id="courseDesc">
                        </div>
