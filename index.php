                        ...
                        <form method="post" action="index.php">
                              ...
                              <div class="text-center">
                                    <input type="submit"
                                          ...
                                          value="Log In" />
                                    <p class="my-2 fw-bold">OR</p>
                                    <a href="adminlogin.php"
                                          class="btn btn-outline-dark position-relative text-decoration-none">Login as
                                          Admin</a>
                              </div>
                              ...
                              <div class="text-center">
                                    ...
                                    <a href="signup.php" class="btn btn-outline-dark text-decoration-none">Sign Up</a>
                              </div>
                        </form>
                  </div>
            </div>
